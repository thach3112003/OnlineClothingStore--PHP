...
<body>
    ...
    <section class="header-fixed-top">
        <div class="header-container row fixed-top navbar">
            <header class="header w-100 ps-5 pe-5 navbar navbar-expand-sm expand-header d-flex">
                ...
                <div class="col-4 header-middle_logo d-flex justify-content-center ps-5 ms-5">
                    <div class="logo me-5 pe-5">
                        <a href="../../html/index.html"><img class="ps-5 ms-3" style="width:70%; height:auto;"
                                src="../../image/logo.png" alt="logo" /></a>
                    </div>
                </div>
                <div class="col-4 header-right_user pe-5 me-5 d-flex justify-content-end d-flex">
